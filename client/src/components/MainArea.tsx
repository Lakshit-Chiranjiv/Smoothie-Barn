...
const MainArea = ({user,addModalOpened,setAddModalOpened,authTab,setAuthTab}: MainAreaProps) => {
  ...
  return (
    <Container className='mainarea'>
      <Routes>
        ...
        <Route path='/signup' element={!user ? <AuthTabs authTab={authTab} setAuthTab={setAuthTab}/> : <Navigate to='/'/>}/>
        <Route path='/login' element={!user ? <AuthTabs authTab={authTab} setAuthTab={setAuthTab}/> : <Navigate to='/'/>}/>
        <Route path='/smoothies' element={user ? <SmoothiesList setAddModalOpened={setAddModalOpened}/> : <Navigate to='/'/>}/>
